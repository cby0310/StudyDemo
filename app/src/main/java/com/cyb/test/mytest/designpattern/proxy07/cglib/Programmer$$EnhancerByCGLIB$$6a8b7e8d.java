...
public class Programmer$$EnhancerByCGLIB$$6a8b7e8d extends Programmer implements Factory {
    ...
    static void CGLIB$STATICHOOK1() throws ClassNotFoundException {
        ...
        CGLIB$code$0$Method = ReflectUtils.findMethods(new String[]{"code", "()V"},
                (var1 = Class.forName("com.cyb.test.mytest.designpattern.proxy07.cglib.Programmer")).getDeclaredMethods())[0];
