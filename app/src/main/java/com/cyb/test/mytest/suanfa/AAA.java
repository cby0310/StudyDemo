 ...
 * 46:把数字翻译成字符串 -> 109
 * 47:礼物的最大价值 -> 110
 * 48:最长不含重复字符的子字符串 -> 111 哈希表  耻辱！！
 * 49:丑数 -> 34
 * 50:第一个只出现一次的字符 ->  35 哈希表
 * 51:数组中的逆序对 -> 36 归并排序
 * 52:两个链表的第一个公共节点 -> 37  正难则反,其实这种效率比较低
 * 53:在排序数组中查找数字 -> 112  38
 * 54:二叉搜索树的第k大节点 中序遍历倒序，记得是倒序，先右后左
 * 55:二叉树的深度 -> 39
 * 56:数组中数字出现的次数 -> 40
 * 57:和为s的数字 -> 41
 * 58:翻转字符串 -> 42
 * 59:队列的最大值 -> 113
 * 60:n个骰子🎲的点数 ->  43  ??回溯效率太低
 * 61:扑克牌中的顺子 -> 44
 * 62:圆圈中最后剩下的数字 ->  ??????擦擦擦
 * 63:股票的最大利润 -> 101
 * 64:求1+2+...+n -> 46
