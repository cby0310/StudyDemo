...
public class TestViewTranslation extends View {
    ...
    public TestViewTranslation(Context context) {
        super(context);
        init();
    }

    public TestViewTranslation(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init();
    }

    public TestViewTranslation(Context context, AttributeSet attrs, int defStyleAttr) {
